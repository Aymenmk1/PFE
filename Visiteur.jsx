...
const VILLES = [
  ...
  },
  {
    ...
    tag: "La capitale",
    familles: 28,
    img: "https://images.unsplash.com/photo-1555990793-da09c1734b8e?w=600&q=80",
  },
  {
    id: "tanger",
    nom: "Tanger",
...
function FamillesListing({ onReserver }) {
  ...
  const [filtreSort,  setFiltreSort]  = useState("note");
...
function ModalReservation({ famille, onClose }) {
  ...
  const handleSubmit = () => {
    ...
    setSubmitted(true);
    // TODO: appel API REST → POST /api/reservations
  };
